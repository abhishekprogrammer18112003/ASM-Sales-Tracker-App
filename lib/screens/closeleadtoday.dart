...
class closeleadtoday extends StatefulWidget {
  ...
  closeleadtoday({Key? key, required this.lead_id}) : super(key: key);

  @override
  State<closeleadtoday> createState() => _closeleadtodayState();
}

class _closeleadtodayState extends State<closeleadtoday> {
  String? loginenc_id;
  String? client_id;
