...
//             //       });
//             //     },
//             //     controller: searchcontrollermobile,
//             //     keyboardType: TextInputType.name,
//             //     decoration: InputDecoration(
//             //         hintText: 'Search with mobile number',
//             //         border: OutlineInputBorder(
//             //             borderRadius: BorderRadius.circular(20))),
//             //   ),
//             // ),
...
//                             // childAspectRatio: 1,
//                           ),
//                           itemCount: _todaysleadlist.length,
//                           itemBuilder: (BuildContext context, int index) {
//                             String name = snapshot.data?[index]['name'];
//                             String mobile = snapshot.data?[index]['mobile'];
//                             if (searchcontroller.text.isEmpty) {
//                               return data(_todaysleadlist, index);
//                             } else if (name.toLowerCase().contains(
//                                     searchcontroller.text.toLowerCase()) ||
//                                 mobile.toLowerCase().contains(
//                                     searchcontroller.text.toLowerCase())) {
//                               filterItems(searchcontroller.text);
//                               filterItemsmobile(searchcontrollermobile.text);
              ...
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child:
                        Container(height: 20, width: 30, child: icons[index]),
                  ),
                  SizedBox(
